        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 opacity-75">Chỉnh sửa thông tin danh mục sản phẩm</p>
                </div>
                ...
                <div class="form-card">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Cập nhật thông tin cho danh mục #{{ $category->category_name ?? '' }}</p>
                        </div>
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="slug-preview" id="slugPreview">
                                    {{ url('/categories/') }}/{{ $category->slug ?? 'slug-se-hien-thi-o-day' }}
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#updateCategoryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '/admin/categories/{{ $category->id ?? 0 }}',
                    method: 'PUT',
                    data: formData,
                    ...
                    error: function(xhr) {
                        let message = 'Có lỗi xảy ra khi cập nhật danh mục';
            ...
            // Load existing category data when page loads
            loadCategoryData();
        });
        ...
        function loadCategoryData() {
            @if(isset($category))
                ...
                $('#description').val('{!! addslashes($category->description ?? "") !!}');
                updateSlugPreview($('#slug').val());
            @endif
        }
        ...
        function resetForm() {
            if (confirm('Bạn có chắc muốn khôi phục về giá trị ban đầu?')) {
